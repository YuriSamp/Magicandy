    ...
    return (
        <footer className="flex flex-col items-center gap-2 text-fontPurple text-3xl border-t-2 pt-10 bg-[#f8f8ff]">
            ...
            <div className='flex flex-col pb-10 md:flex-row gap-10'>
                <div className='flex flex-col text-2xl  text-center items-center gap-2'>
                ...
                <div className='flex flex-col text-2xl pl-10 text-center items-center gap-2 border-l-4 border-fontPurple'>
